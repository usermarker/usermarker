...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>特点：</td>
								<td colspan="4">
									<input type="checkbox" name="expressTrait" value="耐心">耐心
									<input type="checkbox" name="expressTrait" value="热情">热情
									<input type="checkbox" name="expressTrait" value="干练">干练
									<input type="checkbox" name="expressTrait" value="效率">效率
								</td>
							</tr>
	...
	<!-- 导入对话框 -->
	<div class="modal fade" id="person_imp" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_person" method="post" action="impPerson.htm" enctype="multipart/form-data">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_person_imp_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	        ...
	        $('#table_user').bootstrapTable({
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                sortable:true,
	                formatter:function(value,row,index){
	                	return row.company.expressName;
	                }
	            },{
	                field: 'createTime',
	                title: '创建时间',
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_imp").click(function(){
	    		document.getElementById("hidden_txt_userid").value='';
	    		$('#person_imp').modal({backdrop: 'static', keyboard: false});
