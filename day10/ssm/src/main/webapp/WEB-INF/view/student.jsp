...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="input-group">
                ...
                <input readonly="readonly" placeholder="请输入时间"id="txt_search_end" name="entrytime" class="laydate-icon form-control layer-date"/>
			</div>
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>专业：</td>
								<td>
									<select class="form-control" name="choolid" id = "choolid" aria-required="true" required>
										<option value="">---请选择---</option>
							...
							<td>入校时间：</td>
								<td colspan="4">
									<input readonly="readonly" placeholder="开始时间" id="txt_search_start" name="entrytime" class="laydate-icon form-control "/>
								</td>
							</tr>
						</table>
	...
	<!-- 添加课程对话框 -->
	<div class="modal fade" id="modal_addCourse" role="dialog" aria-labelledby="modal_addCourse" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addCourse").click(function(){
    			$('#modal_addCourse').modal({backdrop: 'static', keyboard: false});
    			$("#modal_addCourse").show();
	        });
	...
	function initEditUser(getSelection){
		...
		$('#txt_search_start').val(new Date(getSelection.entrytime).Format("yyyy-MM-dd"));
		$('#choolid').val(getSelection.choolid);
	}
