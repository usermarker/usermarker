				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table
							...
							<tr>
								<td>特点：</td>
								<td colspan="4"><input type="checkbox" name="expressTrait"
									value="耐心" />耐心 <input type="checkbox" name="expressTrait"
									value="热情" />热情 <input type="checkbox" name="expressTrait"
									value="干练" />干练 <input type="checkbox" name="expressTrait"
									value="效率" />效率</td>

							</tr>
							<tr>
								<td valign="middle">入职时间：</td>
								<td colspan="4"><input type="date" name="entryTime"
									id="entryTime" /></td>
							</tr>
							<tr>
								<td valign="middle">所属公司：</td>
								<td colspan="4"><select class="form-control"
									name="expressTypeId" id="expressTypeId">
										<option value="0">---请选择---</option>
										<c:forEach items="${companyList }" var="c">
											<option value="${c.id }">${c.expressName }</option>
										</c:forEach>
