...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>人员爱好：</td>
								<td>
									<input type="checkbox" id="pLike1" name="pLike" value="名表" aria-required="true" required/>名表
									<input type="checkbox" id="pLike2" name="pLike" value="豪车" aria-required="true" required/>豪车
	...
	<div class="modal fade" id="modal_user_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveType.htm">
						<input type="hidden" name=pId id="hidden_txt_userid" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>人员姓名：</td>
	...
	<div class="modal fade" id="modal_user_echarts" role="dialog" aria-labelledby="modal_user_echarts" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head"> 统计  </h4>
				</div>
				<div class="modal-body">
	    		...
	    		$.ajax({
	    			...
	    			dataType:"json",
	    			 ...
	    			 res.list.forEach(function(person){
	    				xdata.push(person.cname);
	    				ydata.push({value:person.num,name:person.cname});
	    			 });
	    			 if(res.success){
	    				option = {
	    					 title: {
